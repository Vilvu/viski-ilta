...
export default function WhiskeyDetailPage() {
  ...
  if (!whiskey) return <div className={styles.error}>{t('whiskeyDetail.notFound')}</div>;
      ...
      <div className={styles.whiskeyHeader}>
         ...
         <div className={styles.headerActions}>
            {showEditForm && canDeleteWhiskey() && (
              ...
              >
                {removeWhiskey.isPending ? t('common.deleting') : t('whiskeyDetail.deleteWhiskey')}
              </button>
            )}
        ...
        {showEditForm && (
          <form className={styles.form} onSubmit={handleWhiskeyEditSubmit}>
           ...
           <div className={styles.formActions}>
              ...
              >
                {updateWhiskey.isPending ? t('common.saving') : t('common.saveChanges')}
              </button>
           </div>
         </form>
       )}
       ...
       <div className={styles.allRatings}>
         <h2>{t('whiskeyDetail.allRatings')} ({ratings?.length ?? 0})</h2>
         {ratings?.length === 0 ? (
                ...
                <div className={styles.ratingContent}>
                  ...
                  {rating.notes && (
                   ...
                   <div className={styles.ratingDate}>
                     {new Date(rating.createdAt).toLocaleDateString(i18n.language === 'fi' ? 'fi-FI' : 'en-GB')}
                   </div>
                </div>
              </div>
            ))}
