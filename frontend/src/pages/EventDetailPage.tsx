...
export default function EventDetailPage() {
  ...
  const handleEventEditSubmit = async (e: React.FormEvent) => {
    ...
    await updateEvent.mutateAsync({
      id: eventId,
      input: submitData as UpdateEventInput,
    });
  ...
  if (!event)
    return <div className={styles.error}>{t('eventDetail.notFound')}</div>;
  ...
  return (
    <div className={styles.page}>
        ...
        <form className={styles.form} onSubmit={handleEventEditSubmit}>
          ...
          <div className={styles.formGroup}>
            <label htmlFor="edit-name">
              {t('eventDetail.formLabels.eventName')} *
            </label>
            <input
              id="edit-name"
              type="text"
          ...
          <div className={styles.formGroup}>
            <label htmlFor="edit-description">
              {t('eventDetail.formLabels.description')}
            </label>
            <textarea
              id="edit-description"
          ...
          <div className={styles.formRow}>
            ...
            <div className={styles.formGroup}>
              <label htmlFor="edit-location">
                {t('eventDetail.formLabels.location')}
              </label>
              <input
                id="edit-location"
                type="text"
      ...
      {whiskeysLoading ? (
        ...
        <div className={styles.empty}>{t('eventDetail.emptyMessage')}</div>
      ) : (
                    ...
                    {whiskey.userRating !== undefined && (
                      ...
                      >
                        <span className={styles.ratingLabel}>
                          {t('eventDetail.ratingLabels.you')}
                        </span>
