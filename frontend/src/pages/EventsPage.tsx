...
export default function EventsPage() {
  ...
  if (error) return <div className={styles.error}>{t('events.loadFailed')}</div>;
      ...
      <div className={styles.header}>
       ...
       {showForm && (
         <form className={styles.form} onSubmit={handleSubmit}>
           ...
           <div className={styles.formActions}>
             ...
             >
               {createEvent.isPending ? t('common.creating') : t('events.createEvent')}
             </button>
           </div>
         </form>
       )}
       ...
       {events?.length === 0 ? (
         <div className={styles.empty}>
           <p>
             {isTaster ? t('events.emptyMessage') : t('events.emptyTasterMessage')}
           </p>
         </div>
       ) : (
