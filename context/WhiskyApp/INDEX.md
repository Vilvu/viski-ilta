...
**WhiskyApp** is a web application for recording and tracking user whisky ratings from whisky tasting events. It supports three user roles — Admin, Authenticated User, and Anonymous User — with Google OAuth authentication, hosted on Microsoft Azure.
